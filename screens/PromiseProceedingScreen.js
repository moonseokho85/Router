...
export default class PromiseProceedingScreen extends Component {
      ...
      <View>
        ...
        >
          <Button
            ...
            onPress={() => navigate("PromiseWaiting")}
          >
            <Text style={{ color: "gray", textAlign: "center" }}>대기중</Text>
          </Button>
          <Button
            style={{ backgroundColor: "#FFA800", width: 109, height: 35 }}
          >
            <Text style={{ color: "white", textAlign: "center" }}>진행중</Text>
          </Button>
          <Button
            style={{
              backgroundColor: "aliceblue",
